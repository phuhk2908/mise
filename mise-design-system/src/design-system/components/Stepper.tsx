...
export function Stepper({ value, min = 0, max = Number.MAX_SAFE_INTEGER, onChange }: StepperProps) {
  ...
  return (
    ...
    >
      ...
      >
        <Minus size={iconSize.sm} color={colors.textPrimary} strokeWidth={iconStrokeWidth.regular} />
      </Pressable>

      <AppText variant="bodySmall" style={{ minWidth: 32, textAlign: "center" }}>
        {value}
      </AppText>
      ...
      >
        <Plus size={iconSize.sm} color={colors.textPrimary} strokeWidth={iconStrokeWidth.regular} />
      </Pressable>
    </View>
  );
}
